...
public class DIAMIDIAN_SHOVEL {
    public static final Shovel DIAMIDIAN_SHOVEL = new Shovel(new DIAMIDIAN(),-4, -1.0F, new Item.Settings()
            .maxCount(1)
            .fireproof()
            .group(ItemGroup.COMBAT)
    );
    public static void doRegister(){
        Registry.register(Registry.ITEM, new Identifier(Malifence.MOD_ID, "diamidian_shovel"), DIAMIDIAN_SHOVEL);
    }
}
